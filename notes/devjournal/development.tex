...
\title{\textsc{\bfseries Simulating the Evolution of\\ Neural Pathways and Structures} \\ \vspace*{10mm} \Large Development Journal}
...
\begin{figure}[ht!]
    ...
    \end{tikzpicture}
    \caption{Partitioning of environment into $k = 16$ chunks}
\end{figure}
\begin{proposition}
